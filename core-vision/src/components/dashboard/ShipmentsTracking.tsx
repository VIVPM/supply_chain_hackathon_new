    ...
    const fetchShipments = async () => {
      try {
        ...
        const mappedShipments = data.shipments.map(shipment => {
          ...
          // Assuming all are in-transit as per data, no delays calculated (ETAs are past)
          ...
          return {
            ...
            cargo,
            containers,
            status: shipment.status.replace("_", "-"), // Map to frontend status format
            progress,
            eta: shipment.eta,
            priority,
            riskLevel,
            lastUpdate: "recent", // Fake, as not available
